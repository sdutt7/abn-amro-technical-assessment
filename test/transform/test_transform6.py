...
def test_transform3():
    ...
    df3 = spark.createDataFrame(
        source_data3, schema=["id", "caller_id", "company", "recipient", "age", "country", "product_sold", "quantity"]
    )

    actual_df = Transform6(df=df2).transform(df3)

    expected_data = [
        ("Belgium", 3, "Bob Brown", 85),
        ("Netherlands", 6, "Emily Green", 43),
        ("Germany", 7, "Joe Black", 15),
    ]
